...
#적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/김지후/OneDrive/바탕 화면/PythonWorkSpace/나도코딩_파이썬_활용편/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size #이미지의 크기를 구해옴
enemy_width = enemy_size[0] #캐릭터의 가로 크기
enemy_height = enemy_size[1] #캐릭터의 세로 크기
enemy_x_pos = (screen_width - enemy_width) / 2  #화면 가로의 절반 크기에 해당하는 곳에 위치
enemy_y_pos = (screen_height - enemy_height) / 2 #화면 세로크기 가장 아래에 해당하는 곳에 위치
